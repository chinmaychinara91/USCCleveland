...
mov_img_orig = (
    "/deneb_disk/auto_resection/Ken_Post-op_MRI/sub-SUB111/sMRI/sub-SUB111-111_MRI.nii"
)
mov_img = "/deneb_disk/auto_resection/Ken_Post-op_MRI/sub-SUB111/sMRI/sub-SUB111-111_MRI.bse.nii.gz"
ref_img = (
    "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/T1s.bse.nii.gz"
)
ref_img_mask = (
    "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/T1s.mask.nii.gz"
)
ref_img_bfc = (
    "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/T1s.bfc.nii.gz"
)
...
error_mask_img = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/error_pre_post.nonlin.mask.nii.gz"
error_init_mask_img = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/error_pre_post.nonlin.init.mask.nii.gz"

error_mask_img_rigid = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/error_pre_post.init.mask.nii.gz"
target_msk_file = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/target.mask.nii.gz"

# rigidly warped image
rigid_reg_img = (
    "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/post2pre.nii.gz"
)
nonlin_reg_img_pvc_frac = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/post2pre.nonlin.warped.pvc.frac.nii.gz"
...
jac_file = (
    "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/jacobian.nii.gz"
)


ddf = "/deneb_disk/auto_resection/Andrew_Pre-op_MRI_and_EZ_Map/Subject111/ddf_nonlin.nii.gz"
