...
class Warper:
	...
	def nonlinear_reg(self,target_file, moving_file, output_file, label_file=None, ddf_file=None, output_label_file=None, jacobian_determinant_file=None, loss='cc', reg_penalty=0.3, nn_input_size=64, lr=1e-6, max_epochs=1000, device='cuda'):
